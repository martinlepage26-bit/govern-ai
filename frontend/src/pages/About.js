      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="card mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {stepKeys.map((key, i) => (
              <div key={key} className="bg-[#F6F7FB] rounded-lg p-5 border-t-3 border-[#4B2ABF]" data-testid={`practice-step-${i + 1}`}>
                <div className="flex items-center gap-3 mb-3">
                  <span className="w-8 h-8 rounded-full bg-[#4B2ABF] text-white flex items-center justify-center font-semibold text-sm">{i + 1}</span>
                  <h3 className="font-serif font-semibold text-[#0B0F1A] underline decoration-[#4B2ABF]">{t.about.steps[key].title}</h3>
                </div>
        ...
        <div className="card mb-8">
          ...
          <div className="flex flex-col md:flex-row gap-6 items-start">
            ...
            <div className="flex-1">
              ...
              <Link to="/portfolio" className="inline-flex items-center gap-2 text-[#4B2ABF] font-medium hover:gap-3 transition-all group" data-testid="portfolio-link">
        ...
        <div className="card border-l-4 border-[#4B2ABF]">
          <p className="text-xs tracking-widest text-[#4B2ABF] uppercase mb-2">{t.about.featuredResearch}</p>
          ...
          <Link to="/sealed-card" className="inline-flex items-center gap-2 text-[#4B2ABF] font-medium text-sm hover:gap-3 transition-all">
